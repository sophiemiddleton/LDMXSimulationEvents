...
Lumi = 0.22
ProtonsPerN = 74
Factor5 = 3.727*Lumi*ProtonsPerN
Factor30 = 0.3678*Lumi*ProtonsPerN
Factor20 = 0.5118*Lumi*ProtonsPerN
Factor10 = 1.305*Lumi*ProtonsPerN
Factor15 = 1.67*Lumi*ProtonsPerN
Factor25 = 0.4151*Lumi*ProtonsPerN
FF=3
if FF==1:
    Eventweight =278.4
...
if FF==3:
    Eventweight = 0.3678
    data0=readLHEF('FFop3_cuts/5deg.lhe')
    data1=readLHEF('FFop3_cuts/30_001.lhe')
    data2=readLHEF('FFop3_cuts/20deg.lhe')
    data3=readLHEF('FFop3_cuts/10deg.lhe')
    data4=readLHEF('FFop3_cuts/15deg.lhe')
    data5=readLHEF('FFop3_cuts/25deg.lhe')
if FF==4:
...
hist_Px_out_5Deg=TH1F("P_{z} out 5 deg", "#theta_{min}=5 ", 100,-2,2)
hist_Pz_out_5Deg=TH1F("P_{x} out 5 deg", "#theta_{min}=5", 100,-2,2)
hist_Py_out_5Deg=TH1F("P_{y} out 5 deg", "#theta_{min}=5 ", 100,-2,2)
hist_E_out_5Deg=TH1F("E out 5 deg", "#theta_{min}=5", 100,0,2)

hist_Px_out_10Deg=TH1F("P_{z} out 10 deg", "#theta_{min}=10 ", 100,-2,2)
hist_Pz_out_10Deg=TH1F("P_{x} out 10 deg", "#theta_{min}=10", 100,-2,2)
hist_Py_out_10Deg=TH1F("P_{y} out 10 deg", "#theta_{min}=10 ", 100,-2,2)
hist_E_out_10Deg=TH1F("E out 10 deg", "#theta_{min}=10", 100,0,2)

hist_Px_out_15Deg=TH1F("P_{z} out 15 deg", "#theta_{min}=15 ", 100,-2,2)
hist_Pz_out_15Deg=TH1F("P_{x} out 15 deg", "#theta_{min}=15", 100,-2,2)
hist_Py_out_15Deg=TH1F("P_{y} out 15 deg", "#theta_{min}=15 ", 100,-2,2)
hist_E_out_15Deg=TH1F("E out 15 deg", "#theta_{min}=15", 100,0,2)

hist_Px_out_20Deg=TH1F("P_{z} out 20 deg", "#theta_{min}=20", 100,-2,2)
hist_Pz_out_20Deg=TH1F("P_{x} out 20 deg", "#theta_{min}=20", 100,-2,2)
hist_Py_out_20Deg=TH1F("P_{y} out 20 deg", "#theta_{min}=20", 100,-2,2)
hist_E_out_20Deg=TH1F("E out  20 deg", "#theta_{min}=20", 100,0,2)

hist_Px_out_25Deg=TH1F("P_{z} out 25 deg", "#theta_{min}=25 ", 100,-2,2)
hist_Pz_out_25Deg=TH1F("P_{x} out 25 deg", "#theta_{min}=25", 100,-2,2)
hist_Py_out_25Deg=TH1F("P_{y} out 25 deg", "#theta_{min}=25 ", 100,-2,2)
hist_E_out_25Deg=TH1F("E out 25 deg", "#theta_{min}=25", 100,0,2)

hist_Px_out_30Deg=TH1F("P_{z} out 30 deg", "#theta_{min}=30", 100,-2,2)
hist_Pz_out_30Deg=TH1F("P_{x} out 30 deg", "#theta_{min}=30", 100,-2,2)
hist_Py_out_30Deg=TH1F("P_{y} out 30 deg", "#theta_{min}=30", 100,-2,2)
hist_E_out_30Deg=TH1F("E out 30 deg", "#theta_{min}=30", 100,0,2)
