...
hist_Pz_out_001=TH1F("P_{x} out 5 deg", "P_{lab}^{#gamma} = 0.01GeV ", 100,-2,5)
hist_Py_out_001=TH1F("P_{y} out 5 deg", "P_{lab}^{#gamma} = 0.01GeV  ", 100,-2,2)
hist_E_out_001=TH1F("E out 5 deg", "P_{lab}^{#gamma} = 0.01GeV ", 100,0,5)

hist_Px_out_01=TH1F("P_{z} out 20 deg", "P_{lab}^{#gamma} = 0.1GeV ", 100,-2,2)
hist_Pz_out_01=TH1F("P_{x} out 20 deg", "P_{lab}^{#gamma} = 0.1GeV ", 100,-2,5)
hist_Py_out_01=TH1F("P_{y} out 20 deg", "P_{lab}^{#gamma} = 0.1GeV ", 100,-2,2)
hist_E_out_01=TH1F("E out  20 deg", "P_{lab}^{#gamma} = 0.01GeV ", 100,0,5)

hist_Px_out_1=TH1F("P_{z} out 30 deg", "P_{lab}^{#gamma} = 1GeV ", 100,-2,2)
hist_Pz_out_1=TH1F("P_{x} out 30 deg", "P_{lab}^{#gamma} = 1GeV ", 100,-2,5)
hist_Py_out_1=TH1F("P_{y} out 30 deg", "P_{lab}^{#gamma} = 1GeV ", 100,-2,2)
hist_E_out_1=TH1F("E out 30 deg", "P_{lab}^{#gamma} = 1GeV ", 100,0,5)
...
hist_4out.Draw()
c.SaveAs("photon_angle_plots_lab_30deg"+str(FF)+".root")
