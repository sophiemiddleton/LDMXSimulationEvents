...
proton3=data3.getParticlesByIDs([9000002,-9000002])
proton4=data4.getParticlesByIDs([9000002,-9000002])
proton5=data5.getParticlesByIDs([9000002,-9000002])
...
hist_dr_5=TH1F("Opening Angle", "#theta_{#gamma} > 5", 100,0,2)
hist_dr_10=TH1F("Opening Angle ", " #theta_{#gamma} > 10", 100,0,2)
hist_dr_20=TH1F("Opening Angle", "#theta_{#gamma} > 20", 100,0,2)
hist_dr_30=TH1F("Opening Angle", " #theta_{#gamma} > 30", 100,0,2)

hist_pt_5_elec=TH1F("pt ", "pt #theta_{#gamma} > 5", 100,0,1.5)
hist_pt_10_elec=TH1F("pt ", "pt #theta_{#gamma} > 10", 100,0,1.5)
hist_pt_20_elec=TH1F("pt ", "pt #theta_{#gamma} > 20", 100,0,1.5)
hist_pt_30_elec=TH1F("pt ", "pt #theta_{#gamma} > 30", 100,0,1.5)

hist_pt_5_phot=TH1F("pt ", "pt #theta_{#gamma} > 5", 100,0,1.5)
hist_pt_10_phot=TH1F("pt ", "pt #theta_{#gamma} > 10", 100,0,1.5)
hist_pt_20_phot=TH1F("pt ", "pt #theta_{#gamma} > 20", 100,0,1.5)
hist_pt_30_phot=TH1F("pt ", "pt #theta_{#gamma} > 30", 100,0,1.5)

hist_pt_5_pro=TH1F("pt ", "pt #theta_{#gamma} > 5", 100,0,1.5)
hist_pt_10_pro=TH1F("pt ", "pt #theta_{#gamma} > 10", 100,0,1.5)
hist_pt_20_pro=TH1F("pt ", "pt #theta_{#gamma} > 20", 100,0,1.5)
hist_pt_30_pro=TH1F("pt ", "pt #theta_{#gamma} > 30", 100,0,1.5)
...
for p in proton3:
    if p.status is 1:
        hist_pt_10_pro.Fill(p.pt, Factor10)
...
for p in proton2:
    if p.status is 1:
        hist_pt_20_pro.Fill(p.pt, Factor20)
...
for p in proton1:
    if p.status is 1:
        hist_pt_30_pro.Fill(p.pt, Factor30)
...
c_mom.cd(1)
hist_dr_5.GetXaxis().SetTitle("Opening Angle [rad]")
#hist_dr_5.Draw("HIST")
hist_dr_5.SetLineColor(3)
hist_dr_10.GetXaxis().SetTitle("Opening Angle [rad]")
hist_dr_10.Draw("HISTSAME")
hist_dr_20.GetXaxis().SetTitle("Opening Angle [rad]")
hist_dr_20.SetLineColor(2)
hist_dr_20.Draw("HISTSAME")
hist_dr_30.GetXaxis().SetTitle("Opening Angle [rad]")
hist_dr_30.SetLineColor(6)
hist_dr_30.Draw("HISTSAME")
c_mom.cd(2)
hist_pt_10_pro.GetXaxis().SetTitle("outgoing proton p_{t} [ GeV/c]")
hist_pt_10_pro.Draw("HISTSAME")
hist_pt_20_pro.GetXaxis().SetTitle("outgoing proton p_{t} [ GeV/c]")
hist_pt_20_pro.SetLineColor(2)
hist_pt_20_pro.Draw("HISTSAME")
hist_pt_30_pro.GetXaxis().SetTitle("outgoing proton p_{t} [ GeV/c]")
hist_pt_30_pro.SetLineColor(6)
hist_pt_30_pro.Draw("HISTSAME")
c_mom.cd(3)
hist_pt_5_phot.GetXaxis().SetTitle("photon p_{t} [ GeV/c]")
#hist_dr_5.Draw("HIST")
hist_pt_5_phot.SetLineColor(3)
hist_pt_10_phot.GetXaxis().SetTitle("photon p_{t} [ GeV/c]")
hist_pt_10_phot.Draw("HISTSAME")
hist_pt_20_phot.GetXaxis().SetTitle("photon p_{t} [ GeV/c]")
hist_pt_20_phot.SetLineColor(2)
hist_pt_20_phot.Draw("HISTSAME")
hist_pt_30_phot.GetXaxis().SetTitle("photon p_{t} [ GeV/c]")
hist_pt_30_phot.SetLineColor(6)
hist_pt_30_phot.Draw("HISTSAME")

c_mom.cd(4)
hist_pt_5_elec.GetXaxis().SetTitle("outgoing electron p_{t} [ GeV/c]")
#hist_dr_5.Draw("HIST")
hist_pt_5_elec.SetLineColor(3)
hist_pt_10_elec.GetXaxis().SetTitle("outgoing electron p_{t} [ GeV/c]")
hist_pt_10_elec.Draw("HISTSAME")
hist_pt_20_elec.GetXaxis().SetTitle("outgoing electron p_{t} [ GeV/c]")
hist_pt_20_elec.SetLineColor(2)
hist_pt_20_elec.Draw("HISTSAME")
hist_pt_30_elec.GetXaxis().SetTitle("outgoing electron p_{t} [ MeV/c]")
