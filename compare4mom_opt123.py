...
hist_4mom_diff_opt3=TH1F("#Delta q^{2} in opt2", "Outgoing - Incoming Electron q^{2} opt3", 100,0,4.5)
hist_4momRatio=TH1F("q^{2} out opt1/opt2", "Ratio q^{2} of opt1/opt2 ", 100,0,4.5)
...
for e in electrons03:
    ...
    if e.status is 1:
        print('outgoing', e.eventid)
        squared_4mom_out = (e.px*e.px + e.py*e.py+e.pz*e.pz+e.energy*e.energy)
    hist_4mom_diff_opt3.Fill(squared_4mom_out-squared_4mom_in)
